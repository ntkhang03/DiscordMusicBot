...
module.exports = {
  name: "skipto",
  description: `Chuyển đến một bài hát trong danh sách chờ`,
  usage: "<number>",
  permissions: {
  ...
  run: async (client, message, args, { GuildDB }) => {
    ...
    if (!message.member.voice.channel) return client.sendTime(message.channel, "❌ | **Bạn phải ở cùng kênh thoại với bot để sử dụng lệnh này!**");
    ...
    try {
      ...
      client.sendError(message.channel, "Đã xảy ra lỗi");
    }
  },
  SlashCommand: {
    options: [
      {
        ...
        type: 4,
        required: true,
        description: "Bỏ qua một bài hát cụ thể trong danh sách chờ",
      },
    ],
    /**
     *
    ...
    run: async (client, interaction, args, { GuildDB }) => {
      ...
      try {
        ...
        console.log(String(e.stack).bgRed);
        client.sendError(interaction, "Đã xảy ra lỗi.");
      }
    },
  },
};
